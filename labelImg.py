...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self,
        ...
        deleteImg = action(getStr('deleteImg'), self.deleteImg, 'Ctrl+Shift+D',
        ...
        self.menus = struct(file=self.menu(getStr('menu_file')),
        ...
        addActions(self.menus.file,
                   (open, opendir, copyPrevBounding, changeSavedir,
                    openAnnotation, self.menus.recentFiles, save, save_format,
                    saveAs, close, resetAll, deleteImg, quit))
        addActions(self.menus.help, (help, showInfo))
        addActions(
            self.menus.view,
            (self.autoSaving, self.singleClassMode, self.displayLabelOption,
    ...
    def resetState(self):
        ...
        self.imageData = None
        self.labelFile = None
        self.loadedRootXML = None  # added by ysyun.andy@gmail.com
        ...
        try:
            if self.labelFileFormat == LabelFileFormat.PASCAL_VOC:
                ...
                self.labelFile.savePascalVocFormat(
                    ...
                    existRootXML=self.loadedRootXML)
            elif self.labelFileFormat == LabelFileFormat.YOLO:
                ...
                self.labelFile.saveCreateMLFormat(annotationFilePath, shapes,
                                                  self.filePath,
                                                  self.imageData,
                                                  self.labelHist,
                                                  self.lineColor.getRgb(),
    ...
    def loadPascalXMLByFilename(self, xmlPath):
        ...
        self.loadedRootXML = tVocParseReader.parseXML()
...
def get_main_app(argv=[]):
    ...
    win = MainWindow(args.image_dir, args.predefined_classes_file,
                     args.save_dir)
    win.show()
    return app, win
